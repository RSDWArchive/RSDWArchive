...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plan RSDWArchive git commit batches.")
    ...
    parser.add_argument("--message-prefix", default="Update RSDWArchive data")
    ...
    parser.add_argument(
        "--deletions-first",
        action="store_true",
        help="Put delete-only changes first. RSDWArchive defaults to deletions last.",
    )
