...
REM Paths
REM ============================
set "NEW_JSON=E:\Github\RSDWArchive\0.12.0.0\json"
set "OLD_JSON=E:\Github\RSDWArchive\0.11.2.2\json"

set "NEW_TEXTURES=E:\Github\RSDWArchive\0.12.0.0\textures"
set "OLD_TEXTURES=E:\Github\RSDWArchive\0.11.2.2\textures"
...
echo ==========================================
echo.
echo Comparing: 0.11.2.2  --^>  0.12.0.0
echo.
